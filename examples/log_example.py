    ...
    try:
        ...
        with open(temp_log.name, 'r') as f:
            ...
            if content:
                ...
                styled_content = GumWrapper.style(
                    content,
                    foreground="green",
                    border="rounded",
                    padding="1"
...
def demo_custom_log_formats():
    ...
    formats = [
        ...
        ("With timestamps", {"formatter": "text", "prefix": "APP", "time_format": "15:04:05"}),
    ...
    for description, kwargs in formats:
        print(f"{description}:")
        GumWrapper.log(messages[:2], **kwargs)  # Just show first 2 messages
        print()

...
def test_all_methods_exist():
    ...
    expected_methods = [
        "choose", "confirm", "input", "write", "filter", "spin",
        "file", "format", "join", "pager", "style", "table", "log"
    ]
    
    for method_name in expected_methods:
        assert hasattr(GumWrapper, method_name), f"Method {method_name} not found in GumWrapper"
